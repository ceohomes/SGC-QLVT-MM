      ...
      <div className="px-4 py-3">
        ...
        <div className="flex items-center justify-between gap-3 mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-white font-black text-lg leading-none tracking-tight">Quản Lý VT&MMTB</h1>
              <p className="text-royal-200 text-xs font-medium mt-0.5">Theo dõi vật tư - Máy móc thiết bị</p>
            </div>
          </div>
