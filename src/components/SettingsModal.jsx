...
export default function SettingsModal({ isOpen, settings, onClose, onSave }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 modal-backdrop bg-black/50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-violet-200">
        <div className="bg-gradient-to-r from-violet-700 to-purple-700 px-6 py-4 flex items-center justify-between">
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 border border-violet-200 rounded-xl text-sm outline-none focus:border-violet-400 focus:ring-2 focus:ring-violet-100 transition-all"
            />
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                min={1}
                max={365}
                className="w-28 px-3 py-2.5 border border-violet-200 rounded-xl text-sm outline-none focus:border-violet-400 focus:ring-2 focus:ring-violet-100 transition-all text-center font-bold"
              />
          ...
          <div className="bg-violet-50 rounded-xl p-4 text-xs text-violet-700 space-y-1 border border-violet-100">
        ...
        <div className="px-6 py-4 border-t border-violet-100 bg-violet-50 flex justify-end gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 h-9 bg-violet-600 text-white rounded-xl font-bold text-sm hover:bg-violet-700 transition-all active:scale-95"
          >
