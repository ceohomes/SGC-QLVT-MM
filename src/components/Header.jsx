...
export default function Header({ 
  ...
  return (
    <header className="bg-gradient-to-r from-violet-700 via-purple-700 to-indigo-700 shadow-xl sticky top-0 z-50">
        ...
        <div className="flex items-center justify-between gap-3 mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-violet-200 text-xs font-medium mt-0.5">Theo dõi tiến độ vật tư - Kiểm soát PCU</p>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <div className="text-center">
              ...
              <div className="text-violet-200 text-xs">Tổng dòng</div>
            </div>
            <div className="w-px h-8 bg-white/20" />
            <div className="text-center">
              <div className="text-white font-black text-xl leading-none">{filteredRows}</div>
              <div className="text-violet-200 text-xs">Đang hiện</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex-1 min-w-[180px] max-w-sm relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 h-9 bg-white/15 border border-white/25 rounded-lg text-white placeholder-violet-300 text-sm focus:bg-white/25 focus:border-white/50 transition-all outline-none"
            />
          </div>
          ...
          <button
            onClick={onAddNew}
            className="flex items-center gap-2 px-4 h-9 bg-white text-violet-700 rounded-lg font-bold text-sm hover:bg-violet-50 transition-all active:scale-95 shadow-lg whitespace-nowrap"
          >
