...
const MENU_GROUPS = [
  {
    ...
    items: [
      { id: 'du-lieu-hop-dong',   label: 'Dữ Liệu Hợp Đồng',    icon: FileText,     active: true },
      { id: 'theo-doi-thanh-toan',label: 'Theo Dõi Thanh Toán',  icon: CreditCard },
      { id: 'phan-loai-chi-phi',  label: 'Phân loại chi phí',    icon: Tag },
      { id: 'tien-do-cong-viec',  label: 'Tiến độ công việc',    icon: TrendingUp },
      { id: 'bao-cao-quan-tri',   label: 'Báo cáo Quản trị',     icon: BarChart2 },
      { id: 'danh-sach-du-an',    label: 'Danh sách dự án',      icon: FolderOpen },
    ],
  },
  {
    id: 'nhom-cdt',
    ...
    items: [
      { id: 'du-lieu-hop-dong-cdt', label: 'Dữ liệu Hợp đồng', icon: FileText },
      { id: 'cong-viec-tqt',        label: 'Công việc TQT',     icon: ClipboardList },
      { id: 'theo-doi-trinh-ky',    label: 'Theo dõi trình ký', icon: Clock },
      { id: 'bao-cao-quan-tri-cdt', label: 'Báo cáo Quản trị',  icon: BarChart },
      { id: 'danh-sach-du-an-cdt',  label: 'Danh sách dự án',   icon: FolderOpen },
    ],
  },
  {
    id: 'quan-ly-vat-tu',
    ...
    icon: ClipboardList,
    color: 'from-royal-500 to-royal-400',
    items: [
      { id: 'qlvt-main', label: 'Quản Lý Vật Tư & PCU', icon: Package, active: true, current: true },
    ],
  },
  {
    id: 'administration',
        ...
        <div className="relative flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-4 py-4 border-b border-white/10 shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-white font-black text-sm leading-none">SGC App</div>
