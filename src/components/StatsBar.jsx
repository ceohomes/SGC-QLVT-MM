      ...
      {stats.map(s => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className={`text-[14px] font-semibold ${s.textLabel} mt-0.5 truncate`}>{s.label}</div>
            {s.note && (
              <div className={`text-[12px] font-medium ${s.textLabel} opacity-60 truncate`}>{s.note}</div>
            )}
          ...
          <div className={`text-[14px] font-black ${s.textLabel} tabular-nums shrink-0`}>{s.pct}%</div>
